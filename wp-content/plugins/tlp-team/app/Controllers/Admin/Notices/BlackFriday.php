...
class BlackFriday {
	...
	public function bf_notice() {
		if ( get_option( 'rtteam_bf_2023' ) != '1' ) {
			if ( ! isset( $GLOBALS['rt_team_bf_2022_notice'] ) ) {
				$GLOBALS['rt_team_bf_2022_notice'] = 'rtteam_bf_2023';
				self::notice();
			}
		}
	}
	...
	private static function notice() {
		...
		add_action(
			...
			function () {
				...
				<div class="notice notice-info is-dismissible rttm-black-friday" data-rtteamdismissable="rtteam_bf_2023"
		...
		add_action(
			...
			function () {
				...
				update_option( 'rtteam_bf_2023', '1' );
				wp_die();
			}
		);
	}
